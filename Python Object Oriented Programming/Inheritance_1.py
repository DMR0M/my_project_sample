...
class Employee:
    ...
    def __init__(self, working_time, salary, promotion: bool):
    ...
    def display_employee_status(self):
        return f'Number of worked hrs: {self.w_time}\n' \
...
class Manager(Employee):
    def __init__(self, m_working_time, m_salary, m_promotion,
                 subordinates: list):
        super().__init__(m_working_time, m_salary, m_promotion)
        self.subordinates = subordinates


class Supervisor(Employee):
    def __init__(self, s_working_time, s_salary, s_promotion, supervise_time):
        super().__init__(s_working_time, s_salary, s_promotion)
